    ...
    return (
        <div className="container py-4">
            ...
            <p>
                ...
                terms and conditions. These terms govern your use of our
                services and your responsibilities as a user.
            </p>
            ...
            <p>
                ...
                property of PostnatalCare+ and may not be reproduced without
                permission.
            </p>

            <h5>Disclaimer</h5>
            <p>
                This platform provides educational and tracking tools. It is not
